...
public class EnemyController : BaseController
{
    ...
    protected override void Dead()
    {
        ...
        StartCoroutine(StartDie(enemy.DeadTime));
    ...
    IEnumerator StartDie(float deadTime)
    {
...
                // 아이템을 몬스터가 죽은 위치에 생성
                ...
                dropPos.y += 0.1f; // 절대 바닥에 끼지 않도록
                GameObject itemInstance = Instantiate(itemToDrop, dropPos, Quaternion.identity);
